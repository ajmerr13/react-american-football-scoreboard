    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick = {() => setHomeScore(homeScore + 1)} className="homeButtons_extraPoint">Home Team XP</button>
          <button onClick = {() => setHomeScore(homeScore + 2)} className="homeButtons_safety">Home Team Safety</button>
        </div>
        ...
        <button onClick = {() => setAwayScore(awayScore + 1)} className="awayButtons_extraPoint">Away Team XP</button>
        <button onClick = {() => setAwayScore(awayScore + 2)} className="awayButtons_safety">Away Team Safety</button>
        </div>
      </section>
    </div>
  );
